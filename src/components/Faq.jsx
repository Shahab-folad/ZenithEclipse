      ...
      {faqs.map((faq, index) => (
        ...
        >
          <button onClick={() => setOpenIndex(index === openIndex ? null : index)}
            className={`px-5 w-full flex items-center justify-start gap-5 py-2 text-base md:text-lg transition-all standard-p-big hover:bg-custom-yellow hover:text-white  cursor-pointer border ${index === openIndex ? "bg-custom-yellow text-white" : "bg-custom-gray border-custom-gray "} `}
          >
           <div>
